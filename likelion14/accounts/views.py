...
KAKAO_AUTH_URL = get_secret("KAKAO_AUTH_URL")
...
def kakao_login(request):
        return redirect(f"{KAKAO_AUTH_URL}?client_id={KAKAO_CLIENT_ID}&redirect_uri={KAKAO_REDIRECT_URI}&response_type=code&scope=profile_nickname,account_email")
